...
Това е Java проект, реализиращ клиент-сървърна архитектура за паралелно сортиране на данни. Приложението демонстрира използването на **Java Sockets**, **Object Serialization** и **Fork/Join Framework** за многонишково програмиране.

## Функционалности

1.  **Multithreaded Server:** Сървърът може да обслужва множество клиенти едновременно (Thread-per-Client модел).
...
* **Java JDK:** версия 17 или по-нова.
